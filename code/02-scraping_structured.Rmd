...
film_noir_tbl <- map(content, extract_content)

film_noir_tbl[[19]][[2]] <- c(film_noir_tbl[[19]][[2]][1:10], NA, film_noir_tbl[[19]][[2]][11:49])
film_noir_tbl[[20]][[2]] <- c(film_noir_tbl[[20]][[2]][1:26], NA, film_noir_tbl[[20]][[2]][27:32])

film_noir_tbl[[19]] <- film_noir_tbl[[19]][[1]] |> mutate(rating = film_noir_tbl[[19]][[2]])
film_noir_tbl[[20]] <- film_noir_tbl[[20]][[1]] |> mutate(rating = film_noir_tbl[[20]][[2]])

film_noir_tbl |> bind_rows()
```