...
2. Scrape the 10 first movies of the most popular [Film noir movies ](https://www.imdb.com/search/title/?genres=Film-Noir&explore=genres&title_type=feature&ref_=ft_movie_10) in an automated fashion. Make sure to take breaks between requests by including `Sys.sleep(2)`.
...
## loop will break on its own, things will be stored in list anyways
```